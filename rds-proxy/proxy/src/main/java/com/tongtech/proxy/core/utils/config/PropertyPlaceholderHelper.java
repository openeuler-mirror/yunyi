/*
 * Licensed to the TongTech LTD (Tong) under one or more
 * contributor license agreements.  See the NOTICE file distributed with
 * this work for additional information regarding copyright ownership.
 * The Tong licenses this file to You under the Apache License, Version 2.0
...
package com.tongtech.proxy.core.utils.config;
...
public enum PropertyPlaceholderHelper {
    ...
    INSTANCE(
            ...
            DEFAULT_PLACEHOLDER_SUFFIX, DEFAULT_VALUE_SEPARATOR,
            true
    );
    ...
    PropertyPlaceholderHelper(String placeholderPrefix, String placeholderSuffix, String valueSeparator,
        ...
        if (isEmptyString(placeholderPrefix) || isEmptyString(placeholderSuffix)) {
