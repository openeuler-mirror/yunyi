...
public class SeveralCallbackDel extends SeveralCallback {
    private volatile long total_deleted = 0;

    public SeveralCallbackDel(DataResult result, List request) throws IOException {
        super(result, request, "del", false,0);
    }
