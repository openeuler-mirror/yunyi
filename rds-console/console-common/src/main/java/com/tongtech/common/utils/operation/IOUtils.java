...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return com.tongtech.common.utils.operation.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
        com.tongtech.common.utils.operation.ByteArrayOutputStream output = new com.tongtech.common.utils.operation.ByteArrayOutputStream();
        copy(input, output);
    ...
    public static byte[] toByteArray(Reader input, Charset encoding) throws IOException {
        com.tongtech.common.utils.operation.ByteArrayOutputStream output = new ByteArrayOutputStream();
